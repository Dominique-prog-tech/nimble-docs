...
![De lijst met pipeline-statussen.](../images/pipeline-status-lijst.png)
...
ze gewoon. Zo blijft oude informatie leesbaar. Terughalen kan via de [prullenbak](recycle-bin.md).
